                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    >
                      {ch.blocks.map((block) => {
                        ...
                        if (block.type === 'quote') return <blockquote key={block.id} className="border-l-2 border-orange-500 pl-4 my-3 italic text-zinc-600 text-center">{block.text}</blockquote>;
